...
export const itensCollection = database.get<Item>('item')

export const getTenant = database.get<Tenant>('tenant').find('eedc365d-be1c-4da7-9cac-38e1c38315ad')

export const getFertilizante = database.get<Fertilizante>('fertilizante').find('062b92c7-7cc4-4681-b290-01c991556465')