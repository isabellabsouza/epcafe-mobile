...
import InfoFerTalhao from '@/src/components/depesaFertilizante/InfoFerTalhao';
import InfoLinha from '@/src/components/InfoLinha';
import Titulo from '@/src/components/Titulo';
import Toast from '@/src/components/toast/Toast';
import database, { despesasFerTalhoesCollection, despesasFertilizantesCollection, fertilizantesCollection, notasCollection } from '@/src/db';
